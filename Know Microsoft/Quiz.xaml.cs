...
namespace Know_Microsoft
{
    ...
    public sealed partial class Quiz : Page
    {
        ...
        private void q1o1_Checked(object sender, RoutedEventArgs e)
        {
            ...
            switch (rb.GroupName) { 
                ...
                case "q3":
                    ...
                    break;
                case "q4":
                    q4o1.Foreground = new SolidColorBrush(Colors.White);
                    q4o2.Foreground = new SolidColorBrush(Colors.White);
                    q4o3.Foreground = new SolidColorBrush(Colors.White);
                    q4o4.Foreground = new SolidColorBrush(Colors.White);
                    if (rb.Name == q4o4.Name)
                    {
                        rb.Foreground = new SolidColorBrush(Colors.DarkGreen);
                    }
                    else 
                    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (q2o2.IsChecked == true)
            {
                count++;
            }
            if (q3o3.IsChecked == true)
            {
                count++;
            }
            if (q4o4.IsChecked == true)
            {
                count++;
            }
